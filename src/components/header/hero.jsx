...
function Hero({className, ...props}, ref) {
  return (
      <div
          className={`flex justify-center xl:justify-between items-center w-full p-3
      rounded-full hover:bg-th-hover`}
      >
        <div className={`flex gap-3 truncate`}>
          <UserAvatar user={{name: 'Thanh Hoang', image: 'images/cat1.png'}}
                      userName={`Thanh Hoang`}
                      userImageUrl={`images/cat1.png`}
          />
